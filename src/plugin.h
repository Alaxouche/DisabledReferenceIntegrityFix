...
namespace DisabledReferenceIntegrityFix
{
	struct PluginInfo
	{
		...
		static constexpr std::string_view VERSION = "1.3.1";
		static constexpr std::string_view DESCRIPTION = "SKSE plugin to fix incorrectly disabled/misplaced references in Skyrim SE/AE";
